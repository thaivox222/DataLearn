...
Поскольку подключение Snowflake к Суперсет я отработал еще на прошлом воркшопе ZeroToSnowflake, то это проблем не составило. В качестве датасета подключил витрину и набросал несколько базовых чартов. А потом собрал их на одном дашборде. Не супер-красиво, но для учебных целей сгодится )
